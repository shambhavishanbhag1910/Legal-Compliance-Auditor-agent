...
resource "aws_iam_role" "execution" {
  name = "${var.project_name}-execution-${random_id.suffix.hex}"
...
resource "aws_security_group" "task" {
  name        = "${var.project_name}-task-sg-${random_id.suffix.hex}"
...
resource "aws_lb" "app" {
  name               = "ai-compliance-auditor-alb"
